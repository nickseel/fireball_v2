...
public class TextureManager {
    ...
    private static final HashMap<TextureSheetData, TextureRegion[]> textureSheets = new HashMap<TextureSheetData, TextureRegion[]>();
    ...
    public static void loadTextures() {
        ...
        for(TextureSheetData data: TextureSheetData.values()) {
            data.load();
        }
    }

    public static void loadTextureSheet(TextureSheetData data, int sheetRows, int sheetCols) {
        if(textureSheets.get(data) == null) {
            Texture texture = getTexture(data.getTextureData());
    ...
    public static TextureRegion[] getTextureSheet(TextureSheetData data) {
        return textureSheets.get(data);
    }

    public static TextureRegion getTextureRegion(TextureSheetData data, int index) {
        return textureSheets.get(data)[index];
    }

    public static Animation<TextureRegion> makeAnimation(TextureSheetData textureSheet, int startIndex, int endIndex, float frameTime) {
        TextureRegion[] regions = textureSheets.get(textureSheet);
